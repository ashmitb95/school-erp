...
export const DATABASE_SCHEMA = {
  description: "Praxis ERP Database Schema - CRITICAL: All table names are PLURAL. Use 'attendances' (NOT 'attendance'), 'students', 'classes', 'fees', 'exams', 'exam_results', 'staff', 'subjects', 'schools'",
  tables: {
    schools: {
    ...
    students: {
      ...
      columns: {
        ...
        mother_phone: "Mother's phone number (optional)",
        father_email: "Father's email address (optional)",
        mother_email: "Mother's email address (optional)",
        guardian_name: "Guardian's name (optional, if different from parents)",
        guardian_phone: "Guardian's phone number (optional)",
        guardian_email: "Guardian's email address (optional)",
        address: "Home address",
        city: "City",
        state: "State",
        pincode: "Postal code/pincode",
        latitude: "Geographic latitude for transport route mapping (optional)",
        longitude: "Geographic longitude for transport route mapping (optional)",
        transport_route_id: "Foreign key to transport routes table (optional)",
        hostel_room: "Hostel room number (optional)",
        medical_conditions: "Medical conditions or special needs (optional)",
        emergency_contact_name: "Emergency contact name",
        emergency_contact_phone: "Emergency contact phone",
        photo_url: "URL to student photo (optional)",
